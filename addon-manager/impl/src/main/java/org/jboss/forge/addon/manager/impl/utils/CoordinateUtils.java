...
public class CoordinateUtils
{
   ...
   public static AddonId resolveCoordinate(String addonCoordinates,Version runtimeAPIVersion, AddonDependencyResolver resolver) throws IllegalArgumentException
   {
      AddonId addon;
